...
export const WELLS_FARGO_CARDS: Array<CreditCardInput> = [
  ...
  },
  {
    ...
    offers: [
      {
        amount: [{ amount: 300, currency: schemas.CurrenciesEnum.enum.USD }],
        spend: 1000,
        days: 90,
        credits: [],
      ...
      {
        amount: [{ amount: 250, currency: schemas.CurrenciesEnum.enum.USD }],
        spend: 1000,
        days: 90,
        credits: [],
      },
    ...
    historicalOffers: [
      {
        amount: [{ amount: 400, currency: schemas.CurrenciesEnum.enum.USD }],
        spend: 1000,
        days: 90,
        credits: [],
      },
  ...
  },
  {
    ...
    offers: [
      {
        amount: [{ amount: 350, currency: schemas.CurrenciesEnum.enum.USD }],
        spend: 3000,
        days: 90,
        credits: [],
      },
    ...
    historicalOffers: [
      {
        amount: [{ amount: 600, currency: schemas.CurrenciesEnum.enum.USD }],
        spend: 3000,
        days: 90,
        credits: [],
      },
