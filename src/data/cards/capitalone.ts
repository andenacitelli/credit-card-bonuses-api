...
export const CAPITAL_ONE_CARDS: Array<CreditCardInput> = [
  ...
  },
  {
    ...
    isAnnualFeeWaived: false,
    universalCashbackPercent: 1,
    url: "https://www.capitalone.com/small-business/credit-cards/ventureone-business/",
    imageUrl: "/images/capitalone/spark-miles.webp",
    details: "Formerly Spark 1.5% Miles Select. Rebranded April 2026.",
    credits: [],
    offers: [
      {
  ...
  },
  {
    ...
    isAnnualFeeWaived: false,
    universalCashbackPercent: 1,
    url: "https://www.capitalone.com/small-business/credit-cards/venture-business/",
    imageUrl: "/images/capitalone/spark-miles.webp",
    details: "Formerly Spark 2x Miles. Rebranded April 2026.",
    credits: [
      CREDITS.PRECHECK_OR_SIMILAR,
      {
        value: 50,
        description: "Capital One Business Travel Credit",
        weight: WEIGHTS.TRAVEL_CREDIT_FUNGIBLE,
      },
      {
        value: 50,
        description: "Advertising/Software Credit",
        weight: 0.3,
      },
    ],
    offers: [
      {
        ...
        days: 180,
        credits: [],
        details: "75k after $7,500 in 3 months, +75k after $30k in 6 months.",
      },
      {
